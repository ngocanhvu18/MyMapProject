...
class MapsViewController: UIViewController, AutoCompleteControllerDelegate {
    ...
    var isOpenSliderMenu: Bool = false {
        didSet {
            topContrainSliderMenu.constant = isOpenSliderMenu ? 0 : -(UIScreen.main.bounds.height * 1/6 + 20)
    ...
    override func viewDidLoad() {
        ...
        // Clik View Menu
        topContrainSliderMenu.constant = -(UIScreen.main.bounds.height * 1/6 + 20)
    }
    ...
    func passingData(place: GMSPlace) {
        ...
        if source != nil && destination != nil {
            ...
            markerSource.icon = #imageLiteral(resourceName: "icons8-location_filled")
            ...
            markerDestination.icon = #imageLiteral(resourceName: "icons8-location_filled")
